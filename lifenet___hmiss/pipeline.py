...
def get_data(
    ...
    periods = [last_month_4.strftime("%Y%m"),last_month_3.strftime("%Y%m"), last_2_month.strftime("%Y%m"), last_month.strftime("%Y%m")]
